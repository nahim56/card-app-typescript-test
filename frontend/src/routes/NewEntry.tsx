...
export default function NewEntry(){
    ...
    return(
        <section className="flex justify-center flex-col w-fit ml-auto mr-auto mt-10 gap-5 bg-gray-300  shadow-md shadow-gray-500  dark:bg-slate-800 p-8 rounded-md">
